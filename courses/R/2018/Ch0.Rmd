...
```{r,,fig.width=10,fig.height=6,message=FALSE,warning=FALSE, fig.align='center'}
# ggplot2 library
library(ggplot2)
#?qplot
...
```{r,,fig.width=6,fig.height=5,message=FALSE,warning=FALSE, fig.align='center'}
library(calibrate)
...
library(knitr)
purl("Ch0.Rmd",output="Ch0.R", documentation = 0)
```